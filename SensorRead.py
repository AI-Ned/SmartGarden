...
class ReadSensors:
    ...
    def read_sensor(sensor, do_write:bool):
        ...
        if sensor == "moisture1" and do_write:
            DatabaseActions.database_write("moisture_sensor_1="+str(moisture_sensor1))
            return moisture_sensor1
        elif sensor == "moisture1":
            return moisture_sensor1
        
        if sensor == "moisture2" and do_write:
            DatabaseActions.database_write("moisture_sensor_2="+str(moisture_sensor2))
            return moisture_sensor2
        elif sensor == "moisture2":
            return moisture_sensor2
        
        if sensor == "moisture3" and do_write:
            DatabaseActions.database_write("moisture_sensor_3="+str(moisture_sensor3))
            return moisture_sensor3
